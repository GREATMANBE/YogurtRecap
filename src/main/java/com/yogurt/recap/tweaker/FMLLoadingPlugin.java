package com.yogurt.recap.tweaker;
...
/**
 * Mixin bootstrap tweaker (same pattern as ShowSpawnTime-2.1.1).
 */
...
public class FMLLoadingPlugin implements ITweaker {
    ...
    public void injectIntoClassLoader(LaunchClassLoader classLoader) {
        MixinBootstrap.init();
        Mixins.addConfiguration("mixins.yogurtrecap.json");
        MixinEnvironment.getDefaultEnvironment().setObfuscationContext("searge");
        MixinEnvironment.getDefaultEnvironment().setSide(MixinEnvironment.Side.CLIENT);

        // Taken from Resource-Exploit-Fix by Sk1er (as in ShowSpawnTime):
        // ensure the coremod/tweaker jar isn't ignored by Forge's coremod manager.
